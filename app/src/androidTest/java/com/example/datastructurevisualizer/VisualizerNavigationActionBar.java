...
public class VisualizerNavigationActionBar {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void testClickBSTOpensVisualizerWithCorrectActionBar(){
    ...
    @Test
    public void testClickRBTOpensVisualizerWithCorrectActionBar(){
    ...
    @Test
    public void testClickAVLOpensVisualizerWithCorrectActionBar(){
