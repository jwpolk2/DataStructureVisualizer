...
public class Insert_Undo_Redo {
    ...
    @Test
    public void insert_Undo_Redo_DeleteNodes() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.input_nodes),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("658"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.input_nodes),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("63"), closeSoftKeyboard());
