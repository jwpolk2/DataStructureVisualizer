...
public class AVL_InformationPage {
    ...
    @Test
    public void aVL_InformationPage() {
        ...
        ViewInteraction textView = onView(
                allOf(withText("AVL Tree"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("AVL Tree")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("AVL Tree"),
                        withParent(allOf(withId(R.id.action_bar),
                                withParent(withId(R.id.action_bar_container)))),
                        isDisplayed()));
        textView2.check(matches(withText("AVL Tree")));

        ViewInteraction textView3 = onView(
                allOf(withText("Overview"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView3.check(matches(withText("Overview")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withText("Complexities"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView4.check(matches(withText("Complexities")));
        ...
        ViewInteraction textView5 = onView(
                allOf(withText("Code"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView5.check(matches(withText("Code")));
